package com.obsidian.knight_api.utils.spawners;
...
public class ArmouredEntity  {
  ...
  private final Plugin plugin;
    ...
    public ArmouredEntity(Plugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void spawnArmoredZombieWithTarget(Location location, Player player, int amount) {
        for (int i = 0; i < amount; i++) {
            ...
            task.runTaskLater(plugin,  10 * 20); // Schedule the task to run after 5 seconds (5 * 20 ticks)
